...
class ConditionController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('cms.carteira.condition.index', compact('conditions'))
    ...
    public function create()
    {
        ...
        return view('cms.carteira.condition.create', compact('condition'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('cms.carteira.condition.edit', compact('condition'));
    }
