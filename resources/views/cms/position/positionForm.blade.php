      ...
      <div class="card shadow mb-4">
        ...
        <div class="card-body">
            @if( empty($position->id))
                <h2>Não há vagas</h2>
                {{-- <form action="{{ url("") }}/admin/vagas" method="post" class="" enctype="multipart/form-data" id="form-position"> --}}
            @else
            ...
            {{-- <div class="form-row mb-3" id="image_caption" @if( !$position->image ) hidden @endif>
                <div class="col-lg-12">
                    <div class="form-group" >
                        <label for="image_caption" class="form-label">{{ __('Legenda') }}</label>
                        <input id="image_caption" type="text" class="form-control @error('image_caption') is-invalid @enderror" name="image_caption" value="{{ $position->image_caption }}" autocomplete="image_caption" >
                        @error('image_caption')
                            <div class="invalid-feedback" role="alert">{{ $message }}</div>
                        @enderror
                    </div> 
