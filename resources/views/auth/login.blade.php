                ...
                <div class="p-5">
                  ...
                  <form method="POST" action="{{ route('login') }}" class="user">
                    ...
                    <div class="form-group">
                      <input type="email" name="email" class="form-control form-control-user @error('email') is-invalid @enderror" id="email" aria-describedby="emailHelp" placeholder="Insira seu endereço de Email...">
                      @error('email')
