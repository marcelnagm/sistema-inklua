...
class CityBr extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        //
         ...
         Schema::create('city', function (Blueprint $table) {
            ...
            $table->string('ibge')->nullable(false);            
...
DB::statement("INSERT INTO `city` (`id`, `name`, `uf`, `ibge`) VALUES
